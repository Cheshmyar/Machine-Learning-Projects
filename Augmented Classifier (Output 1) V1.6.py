...
outputs = tf.keras.utils.to_categorical(outputs[:, 1], num_classes=3)
...
out = Dense(3, activation="softmax")(ltn)
...
cls.compile(optimizer=opt, loss='categorical_crossentropy', metrics=['categorical_accuracy'])
log_dir = "./Logs/Augmented Classifier Model (Output 1) V1.6/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
directory = './Logs/Augmented Classifier Model (Output 1) V1.6/loss.csv'
...
cls.save('./Models/Augmented Classifier Model (Output 1) V1.6/')
