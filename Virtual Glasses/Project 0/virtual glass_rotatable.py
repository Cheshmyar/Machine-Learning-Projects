...
sunglasses = cv2.imread('./Glasses/3368_Gcut.jpg')
...
def virtual_glass():
    ...
    # there was this other way of defining a webcam using imutils.video that I didn't find functional.
    # so cv2 was the choice :)
    ...
    while 1:
        ...
        # to have coordination's in pixel unit
    
        results = face_detection.process(image)
        # Assigning the attribute "process" from face_detection function to "result"
        if results.detections:
            # If there is any face detected by the model (in the image):
            ...
            for detection in detections:
                ...
                # I wrote the above line just to print it and make sure that all coordination is delivered by model.
                ...
                # sovereignty for left eye, which biased the model towards collapsing in situation where
                # detecting left eye was impossible
                # To overcome that challenge, I set the width of sunglasses to be a combination of both eyes'
                # X coordination.
                ...
                ####################
                sunglasses_small = Image.open("./Glasses/3368_Gcut.jpg")
                ...
                # result = cv2.warpAffine(sunglasses_small, rot_mat, sunglasses_small.shape[1::-1],
                ...
                # Mask is the whole image of sunglasses not including the glasses. we don't need that part,
                # to be more specific we just
