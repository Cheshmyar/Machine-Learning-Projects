...
# Just Three-Time Rejection Vs. Just Four-Time Rejection
...
class_3_outputs = 1 * np.ones(len(class_3_inputs))

main_inputs = np.concatenate((class_2_inputs, class_3_inputs), axis=0)
main_outputs = np.concatenate((class_2_outputs, class_3_outputs), axis=0)
...
log_dir = "./Logs/Main Code V2.2 - Extra V1.2/"
...
cls.save('./Models/Main Code V2.2 - Extra V1.2/')
