...
# Just Four-Time Rejection Vs. Just Five-Time Rejection
...
class_4_outputs = 1 * np.ones(len(class_4_inputs))

main_inputs = np.concatenate((class_3_inputs, class_4_inputs), axis=0)
main_outputs = np.concatenate((class_3_outputs, class_4_outputs), axis=0)
...
log_dir = "./Logs/Main Code V2.2 - Extra V1.3/"
...
cls.save('./Models/Main Code V2.2 - Extra V1.3/')
