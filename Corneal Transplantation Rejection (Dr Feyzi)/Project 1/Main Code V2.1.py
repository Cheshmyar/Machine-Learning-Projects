...
# Just One-Time Rejection Vs. Just Two-Time Rejection
...
class_2_inputs = np.concatenate((inputs_2, inputs_3, inputs_4, inputs_5), axis=0)
class_2_outputs = np.concatenate((outputs_2, outputs_3, outputs_4, outputs_5), axis=0)

class_weight = {0: 1., 1: class_0_inputs.shape[0] / class_1_inputs.shape[0],
                2: class_0_inputs.shape[0] / class_2_inputs.shape[0]}
...
print(main_inputs.shape)
print(main_outputs.shape)
len_zeros = len([i for i in range(main_outputs.shape[0]) if main_outputs[i] == 0])
len_ones = len([i for i in range(main_outputs.shape[0]) if main_outputs[i] == 1])
print(len_zeros)
print(len_ones)
...
cls.save('./Models/Main Code V2.1/')
