...
log_dir = "./Logs/Augmented Classifier Model (Output 0) V1.7/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
directory = './Logs/Augmented Classifier Model (Output 0) V1.7/loss.csv'
...
cls.save('./Models/Augmented Classifier Model (Output 0) V1.7/')
