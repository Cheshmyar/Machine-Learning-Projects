...
log_dir = "./Logs/Augmented Classifier Model (Output 1) V1.6 - Extra V1.2/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
directory = './Logs/Augmented Classifier Model (Output 1) V1.6 - Extra V1.2/loss.csv'
...
cls.save('./Models/Augmented Classifier Model (Output 1) V1.6 - Extra V1.2/')
