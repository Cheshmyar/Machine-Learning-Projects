...
outputs = tf.keras.utils.to_categorical(outputs[:, 0], num_classes=3)
...
log_dir = "./Logs/Augmented Classifier Model (Output 0) V1.4/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
directory = './Logs/Augmented Classifier Model (Output 0) V1.4/loss.csv'
...
cls.save('./Models/Augmented Classifier Model (Output 0) V1.4/')
