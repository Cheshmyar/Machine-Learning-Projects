...
outputs = tf.keras.utils.to_categorical(outputs[:, 1], num_classes=5)
...
log_dir = "./Logs/Augmented Classifier Model (Output 1) V1.4/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
directory = './Logs/Augmented Classifier Model (Output 1) V1.4/loss.csv'
...
cls.save('./Models/Augmented Classifier Model (Output 1) V1.4/')
