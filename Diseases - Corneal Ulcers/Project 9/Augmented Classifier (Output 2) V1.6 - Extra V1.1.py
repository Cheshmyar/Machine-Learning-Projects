...
log_dir = "./Logs/Augmented Classifier Model (Output 2) V1.6 - Extra V1.1/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
directory = './Logs/Augmented Classifier Model (Output 2) V1.6 - Extra V1.1/loss.csv'
...
cls.save('./Models/Augmented Classifier Model (Output 2) V1.6 - Extra V1.1/')
