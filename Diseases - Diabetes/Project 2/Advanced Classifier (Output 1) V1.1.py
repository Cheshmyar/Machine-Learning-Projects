...
log_dir = "./Logs/Advanced Classifier Model V1.1 (Output 1)/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
directory = './Logs/Advanced Classifier Model V1.1 (Output 1)/loss.csv'
csv_logger = CSVLogger(directory, append=True, separator=',')

cls.fit(training_generator, shuffle=True, epochs=50, callbacks=[tensorboard_callback, csv_logger], validation_data=testing_generator)

cls.save('./Models/Advanced Classifier Model V1.1 (Output 1)/')
